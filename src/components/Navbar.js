...
export default function Navbar(props) {
  return (
    <>
      <nav className={`navbar navbar-expand-${props.mode} bg-${props.mode} my-1`}>
        <div className="container-fluid" style={{
          color: props.toggleMode
            === 'light' ? 'white' : 'dark'
        }}>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              <li className="nav-item" style={{ backgroungColor: props.mode === 'light' ? 'white' : 'dark' }}>
            ...
            <div className={`form-check form-switch text-${props.mode === 'light' ? 'dark' : 'light'}`}>
              ...
              <label className="form-check-label" htmlFor="flexSwitchCheckDefault">{props.inpTxt}</label>
            </div>
          </div>
        </div>
      </nav>
